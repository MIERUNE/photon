...
public class PhotonQueryBuilder {
    ...
    .must(QueryBuilders.matchQuery("osm_key_text", query).analyzer("synonym_analyzer"))
    .must(QueryBuilders.matchQuery("osm_value_text", query).analyzer("synonym_analyzer"));
